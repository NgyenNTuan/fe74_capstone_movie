               ...
               <div className="mt-12">
                  ...
                  >
                     <div>
                        ...
                        <input className="w-full text-lg py-1 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type placeholder="mike@gmail.com"
                           {...register("email", {
                     ...
                     <div>
                        <div className="text-sm mt-2 font-bold text-gray-700 tracking-wide">Tài khoản</div>
                        <input className="w-full text-lg py-1 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type placeholder="NguyenDung"
                           {...register("taikhoan", {
                     ...
                     <div>
                        <div className="text-sm mt-2 font-bold text-gray-700 tracking-wide">Password</div>
                        <input className="w-full text-lg py-1 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type placeholder="Password"
                           {...register("matKhau", {
                              required: "Vui lòng nhập tài khoản !",
                              pattern: {
                     ...
                     <div>
                        <div className="text-sm mt-2 font-bold text-gray-700 tracking-wide">Họ và tên</div>
                        <input className="w-full text-lg py-1 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type placeholder="Họ và tên"
                     ...
                     <div>
                        <div className="text-sm mt-2 font-bold text-gray-700 tracking-wide">Số điện thoại</div>
                        <input className="w-full text-lg py-1 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type placeholder="Số điện thoại" 
                        {...register("sodt",{
