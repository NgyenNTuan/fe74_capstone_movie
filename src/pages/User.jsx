         ...
         <div className="max-w-screen-xl mx-auto p-4">
            ...
            <form
               ...
               onSubmit={handleSubmit(async (value) => {
                  ...
                  try {
                     const res = await quanLyNguoiDungServices.updateThongTinUser(value)
                     if (res.data.statusCode) {
                        toast.success("Thay thông tin thành công, Vui lòng nhập lại tài khoản")
            ...
            >
               <div className="grid gap-6 mb-6 md:grid-cols-2">
                  ...
                  <div>
                     ...
                     />
                     <p className="text-red-500 text-[13px]">{errors?.matKhau?.message}</p>
                  </div>
                  <div>
                     <label
                        htmlFor="company"
